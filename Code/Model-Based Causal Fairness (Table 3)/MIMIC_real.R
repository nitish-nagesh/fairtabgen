...
# === List of model names ===
model_names <- c("Decision_Tree", "Logistic_Regression", "Random_Forest", "XGBoost")
...
for (model in model_names) {
  ...
  file_name <- paste0("Real_MIMIC_predictions_", model, ".csv")
...
write.csv(all_results, "fairness_results_all_models_mimic.csv", row.names = FALSE)
